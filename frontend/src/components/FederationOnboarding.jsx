...
export default function FederationOnboarding({ onComplete, onCancel }) {
      ...
      <div className="glass-card" style={{ padding: "36px", background: "#ffffff" }}>
        ...
        {step === 1 && (
          <div className="animate-fade-in">
            <h2 style={{ fontSize: "1.2rem", fontWeight: 700, marginBottom: "20px", display: "flex", alignItems: "center", gap: "10px", color: "var(--primary)" }}>
              <Building2 size={22} /> Step 1: Federation Identity & Credentials
            </h2>

            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
              <div className="input-group" style={{ gridColumn: "1 / -1" }}>
                <label className="input-label">
                  Federation / Cooperative Name <span className="req">*</span>
                </label>
                <input
                  type="text"
                  name="name"
                  ...
                  placeholder="e.g. Sahyadri Farmers & Artisans Cooperative"
        ...
        {step === 2 && (
          <div className="animate-fade-in">
            <h2 style={{ fontSize: "1.2rem", fontWeight: 700, marginBottom: "20px", display: "flex", alignItems: "center", gap: "10px", color: "var(--primary)" }}>
              <MapPin size={22} /> Step 2: Jurisdiction & Registered Address
            </h2>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
              ...
              <div className="input-group">
                <label className="input-label">Headquarters / Street Address</label>
                <input
                  type="text"
                  name="streetAddress"
                  value={formData.streetAddress}
                  onChange={handleChange}
                  placeholder="e.g. Rajarampuri 5th Lane, Main Office"
                  className="custom-input"
                />
              </div>
            </div>
        ...
        {step === 3 && (
          <div className="animate-fade-in">
            <h2 style={{ fontSize: "1.2rem", fontWeight: 700, marginBottom: "20px", display: "flex", alignItems: "center", gap: "10px", color: "var(--primary)" }}>
              <FileText size={22} /> Step 3: Sector Focus & Statutory Mandate
            </h2>
